...
// ======================================
// Realtime Abandoned Cart Auto-Capture & Recovery Module
// ======================================
(function() {
  ...
  function restoreRecoveredData() {
    ...
    function applyData() {
      ...
      // 6. استعادة المقاس واللون والمتغيرات المحددة في صفحة المنتج
      if (isProductPage() && data.items && data.items[0]) {
        ...
        // استعادة الخيارات المخصصة (custom variants)
  ...
  function attachListeners() {
    ...
    // مراقبة تغيير الكمية في صفحة المنتج
