...
<head>
  ...
  <link rel="stylesheet" href="/shop/themes/modern/style.css?v=20260705">
</head>
<body>

    {{-- Top bar --}}
    <nav class="topbar">
        <a href="/shop/" class="topbar-brand">{{ $tenant->name ?? '??????' }}</a>
        <a href="/shop/cart.html" class="topbar-back"><i class="fas fa-arrow-right"></i> ?????? ?????</a>
    </nav>
    ...
    <div class="checkout-wrapper">
        ...
        <div class="checkout-left">
            ...
            <div style="background: linear-gradient(135deg, #eff6ff 0%, #dbeafe 100%); border: 1px solid #bfdbfe; border-radius: 16px; padding: 1rem 1.25rem; margin-bottom: 1.5rem; display: flex; align-items: center; gap: 1rem;">
                ...
                <div>
                    <span style="font-weight: 800; color: #1e3a8a; display: block; font-size: 0.95rem;">????? ?????? ????? (Guest Checkout)</span>
                    <span style="color: #3b82f6; font-size: 0.82rem;">????? ????? ????? ?????? ??? ?????? ?????? ???? ?? ????? ??????.</span>
                </div>
            </div>
            ...
            <form id="checkout-form" onsubmit="placeOrder(event)">
                ...
                {{-- Shipping info --}}
                <div class="card">
                    <h2 class="card-title"><i class="fas fa-map-marker-alt" style="color:var(--primary)"></i> ?????? ?????</h2>
                ...
                {{-- Payment --}}
                <div class="card">
                    <h2 class="card-title"><i class="fas fa-credit-card" style="color:var(--primary)"></i> ????? ?????</h2>
        ...
        <aside class="order-sidebar">
            <div class="sidebar-sticky">
                <div class="card">
                    <h2 class="card-title"><i class="fas fa-shopping-bag" style="color:var(--primary)"></i> ???? ?????</h2>
                    ...
                    <div style="margin-bottom: 1rem;">
                        <label style="display: block; font-size: 0.85rem; font-weight: 700; color: #555; margin-bottom: 0.4rem;"><i class="fas fa-ticket-alt" style="color:var(--primary); margin-left: 0.3rem;"></i> ????? ?????</label>
                        <div style="display: flex; gap: 0.5rem;">
                            <input type="text" id="coupon-input" class="form-control" placeholder="???? ??? ?????" style="flex:1; text-transform:uppercase; padding:0.5rem 0.75rem; font-size:0.85rem;">
                            <button type="button" id="apply-coupon-btn" onclick="applyCoupon()" style="background:var(--primary); color:#fff; border:none; border-radius:10px; padding:0 1rem; font-weight:700; cursor:pointer; font-family:var(--font); font-size:0.85rem;">?????</button>
                        </div>
