...
<head>
    ...
    @endphp
    <title>تم الطلب بنجاح - {{ $storeName }}</title>
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="{{ $storeName }}">
    <meta property="og:title" content="تم الطلب بنجاح - {{ $storeName }}">
...
<body>
    ...
    <div class="success-card">
        ...
        <div class="store-rating-section" style="margin-top: 2rem; margin-bottom: 2rem; border-top: 1px solid #eee; padding-top: 1.5rem; text-align: right;">
            <h3 style="font-size: 1.1rem; font-weight: 800; color: #1a1a2e; margin-bottom: 0.5rem; text-align: center;">تقييم تجربتك مع المتجر</h3>
            <p style="font-size: 0.85rem; color: #666; margin-bottom: 1.25rem; text-align: center;">رأيك يهمنا لمساعدتنا في تقديم خدمة أفضل!</p>
            
            <form id="store-rating-form" style="display: flex; flex-direction: column; gap: 1.2rem;">
                @csrf
                <input type="hidden" name="order_id" value="{{ $order->id }}">
                
                <!-- Products Rating -->
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <span style="font-size: 0.88rem; font-weight: 700; color: #334155;">📦 جودة المنتجات:</span>
                    <div class="stars-rating" data-category="products" style="display: inline-flex; gap: 6px; direction: ltr;">
                        <i class="far fa-star rating-star" data-value="1" style="font-size: 1.4rem; color: #fbbf24; cursor: pointer;"></i>
                        <i class="far fa-star rating-star" data-value="2" style="font-size: 1.4rem; color: #fbbf24; cursor: pointer;"></i>
                        <i class="far fa-star rating-star" data-value="3" style="font-size: 1.4rem; color: #fbbf24; cursor: pointer;"></i>
                        <i class="far fa-star rating-star" data-value="4" style="font-size: 1.4rem; color: #fbbf24; cursor: pointer;"></i>
                        <i class="far fa-star rating-star" data-value="5" style="font-size: 1.4rem; color: #fbbf24; cursor: pointer;"></i>
                    </div>
                    <input type="hidden" name="rating_products" id="rating_products_val" value="">
                </div>
                
                <!-- Shipping Rating -->
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <span style="font-size: 0.88rem; font-weight: 700; color: #334155;">🚀 سرعة الشحن:</span>
                    <div class="stars-rating" data-category="shipping" style="display: inline-flex; gap: 6px; direction: ltr;">
                        <i class="far fa-star rating-star" data-value="1" style="font-size: 1.4rem; color: #fbbf24; cursor: pointer;"></i>
                        <i class="far fa-star rating-star" data-value="2" style="font-size: 1.4rem; color: #fbbf24; cursor: pointer;"></i>
                        <i class="far fa-star rating-star" data-value="3" style="font-size: 1.4rem; color: #fbbf24; cursor: pointer;"></i>
                        <i class="far fa-star rating-star" data-value="4" style="font-size: 1.4rem; color: #fbbf24; cursor: pointer;"></i>
                    ...
                    <input type="hidden" name="rating_shipping" id="rating_shipping_val" value="">
                </div>

                <!-- Service Rating -->
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <span style="font-size: 0.88rem; font-weight: 700; color: #334155;">💬 خدمة العملاء:</span>
                    <div class="stars-rating" data-category="service" style="display: inline-flex; gap: 6px; direction: ltr;">
                        <i class="far fa-star rating-star" data-value="1" style="font-size: 1.4rem; color: #fbbf24; cursor: pointer;"></i>
                        <i class="far fa-star rating-star" data-value="2" style="font-size: 1.4rem; color: #fbbf24; cursor: pointer;"></i>
                        <i class="far fa-star rating-star" data-value="3" style="font-size: 1.4rem; color: #fbbf24; cursor: pointer;"></i>
                        <i class="far fa-star rating-star" data-value="4" style="font-size: 1.4rem; color: #fbbf24; cursor: pointer;"></i>
                    ...
                    <input type="hidden" name="rating_service" id="rating_service_val" value="">
                </div>

                <!-- Comment -->
                <div style="margin-top: 0.5rem;">
                    <label for="store-comment" style="display: block; font-size: 0.88rem; font-weight: 700; color: #334155; margin-bottom: 0.4rem;">تعليقك على تجربة الشراء (اختياري):</label>
                    <textarea id="store-comment" name="comment" rows="3" style="width: 100%; border: 1.5px solid #e2e8f0; border-radius: 12px; padding: 0.75rem; font-family: 'Cairo', sans-serif; font-size: 0.88rem; resize: none; outline: none; transition: border-color 0.2s;" placeholder="اكتب تعليقك هنا..." onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#e2e8f0'"></textarea>
                </div>

                <button type="submit" class="btn btn-primary" style="justify-content: center; width: 100%; padding: 0.85rem; font-size: 0.95rem;">إرسال التقييم للمتجر</button>
            </form>
            <div id="rating-success-message" style="display: none; text-align: center; color: #16a34a; font-weight: 700; margin-top: 1.5rem; font-size: 0.95rem; background: #f0fdf4; padding: 1rem; border-radius: 12px; border: 1px solid #bbf7d0;"></div>
        </div>
